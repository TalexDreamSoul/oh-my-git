...
export const levels: Level[] = [
  {
    ...
    difficulty: 1,
    description: '你加入了一个新项目。主管说：“先建一个 README.md，让大家知道这里是做什么的。”',
  ...
  },
  {
    ...
    difficulty: 1,
    description: '空 README 没什么用。给它写入第一句项目说明。',
  ...
  },
  {
    ...
    difficulty: 1,
    description: '你决定这份 README 可以进入下一次保存。把它加入暂存区。',
  ...
  },
  {
    ...
    difficulty: 1,
    description: '暂存区已经准备好了。现在创建项目历史里的第一个 commit。',
  ...
  },
  {
    ...
    difficulty: 1,
    description: '主管又补了一句：“README 里加上学习 Git 的目标。”修改已经提交过的文件。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '这次变更也确认没问题。把修改暂存并提交。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '你想尝试一个新想法，但不想影响 main。创建一个 feature 分支。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: 'feature 分支已经创建好了。切换过去，准备在里面工作。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '你在 feature 分支上开始写一个小 demo。创建 src/app.js 并提交。',
  ...
  },
  {
    ...
    difficulty: 1,
    description: '你不小心生成了 debug.log。它不应该留下来，先把它从工作区删除。',
...

  {
    ...
    summary: '丢弃工作区里的错误修改。',
    difficulty: 2,
    description: '你把 README 改坏了，但还没有暂存。用 Git 从最近一次提交恢复它。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '你把草稿 notes.txt 加入了暂存区，但它还不该进入下一次提交。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '项目里的 old.txt 已经不需要了。删除它，并让 Git 记录这次删除。',
  ...
  },
  {
    ...
    summary: '把删除动作保存进历史。',
    difficulty: 2,
    description: 'old.txt 的删除已经暂存。创建一次提交，让历史记住它。',
  ...
  },
  {
    ...
    difficulty: 3,
    description: '你想看看上一个版本是什么样。切换到较早的提交，体验 detached HEAD。',
  ...
  },
  {
    ...
    summary: '在旧提交上创建修复分支。',
    difficulty: 3,
    description: '你发现旧版本可以成为另一条故事线。从当前 detached HEAD 创建 hotfix 分支。',
  ...
  },
  {
    ...
    difficulty: 2,
    description: '观察结束后，回到 main 主线继续工作。',
  ...
  },
  {
    ...
    summary: '让工作区重新变干净。',
    difficulty: 2,
    description: '现在既有误改，也有临时文件。用命令让工作区恢复干净。',
